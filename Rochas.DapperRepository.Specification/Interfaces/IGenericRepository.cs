...
namespace Rochas.DapperRepository.Specification.Interfaces
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task BulkCreate(IEnumerable<T> entities, bool persistComposition = false);
        void BulkCreateSync(IEnumerable<T> entities, bool persistComposition = false);
        ...
        Task<ICollection<T>> BulkSearch(object[] criterias, bool loadComposition = false, int recordsLimit = 0, string sortAttributes = null, bool orderDescending = false);
